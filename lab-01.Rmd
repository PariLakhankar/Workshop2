...
**na.rm removes any na values from the set of data to allow the mean and median functions to work**
...
**there may be a larger number of visitors by the end of the year**
